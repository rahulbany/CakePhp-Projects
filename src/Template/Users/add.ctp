						...
						<fieldset>
							<section>
								...
								<label class="input"> <i class="icon-append fa fa-user"></i>
									<?php  echo $this->Form->input('login_name', ['templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'placeholder'=>'Username']);?>
							...
							<section>
								...
								<label class="input"> <i class="icon-append fa fa-lock"></i>
									<?php  echo $this->Form->input('password', ['templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'placeholder'=>'Password']);?>
									<b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i> Enter your password</b> </label>
							</section>
							
							<section>
									<label class="input"> <i class="icon-append fa fa-lock"></i>
									<?php  echo $this->Form->input('cpassword', ['templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'placeholder'=>'Confirm password']);?>
						...
						<fieldset>
									<div class="row">
										<section class="col col-6">
											<label class="input">
											<?php  echo $this->Form->input('first_name', ['templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'placeholder'=>'First name']);?>
											</label>
										</section>
										<section class="col col-6">
											<label class="input">
												<?php  echo $this->Form->input('last_name', ['templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'placeholder'=>'Last name']);?>
											</label>
										</section>
									</div>
