		...
		<section id="widget-grid" class="">
					<div class="row">
						...
						<div class="widget-body">
							<?php echo $this->Form->create($getArea, ['class'=>'smart-form','id'=>'smart-form-register']); ?>
							<header>
							Edit
							</header>
							<fieldset>
								<div class="row">
									<section class="col col-6">
										<label class="input">
										<?php echo $this->Form->input('zip_code', array('label'=>false, 'div'=>false, 'class'=>'form-control', 'required'=>true)); ?>
											<!--input type="text" name="zip_code" placeholder="add zip code"  required-->
										</label>
									</section>
								</div>
								<div class="row">
									<section class="col col-6">
										<label class="input">
										<?php echo $this->Form->input('area_name', array('label'=>false, 'div'=>false, 'class'=>'form-control', 'required'=>true)); ?>
											<!-- input type="text" name="area_name" placeholder="Service Area" required-->
										</label>
									</section>
								</div> 
							</fieldset>
