	...
	<div id="ribbon">
		...
		<ol class="breadcrumb">
			<li>
			 ...
			 <li>
					<?php echo $this->Html->link('Add Service', '/admin/areas/add'); ?>
             </li>
			 <li>
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													...
													<th data-hide="phone,tablet">Service Area Name</th>																				
													<th data-hide="phone,tablet">Action</th>	
												</tr>
											</thead>
											<tbody>
											<?php foreach($getAllData as $job) {
											?>
												<tr> 
													<td><?php echo h($job->zip_code); ?></td>
													<td><?php echo h($job->area_name); ?></td>
													<td class="actions">
