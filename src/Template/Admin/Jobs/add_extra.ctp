...
<style>
					.multi-field-wrapper, .multi-fields, .multi-field  {float:left; width:100%; clear:borth;}
		...
		<section id="widget-grid" class="">
					<div class="row">
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<?php echo $this->Form->create(null, ['url' => ['controller' => 'jobs', 'action' => 'add_extra'],'type' => 'file','class'=>'smart-form','id'=>'smart-form-register']); ?>
							<header>
							Add Extra Service
							</header>
							<fieldset>
											...
											<select name="service_id" required>
												...
												<?php if(!empty($services)) {
													foreach($services as $val) { ?>
														<option value="<?php echo $val->id; ?>"><?php echo $val->service;?></option>
													<?php }
												}?>
											</select> <i></i> </label>
									</section>
								  ...
								  <div class="multi-field-wrapper">
									<div class="multi-fields">
											...
											<div class="multi-field">
														...
														<label class="input">
															<input type="text" name="service_name[]"  placeholder="Extra Service Name" required>
														</label>
														</section>
														
														<section class="col col-3">
														<label class="input">		
															<input type="text" name="service_amount[]"  placeholder="Price" required>
														</label>
														</section>
														<button type="button" class="remove-field btn btn-primary">Remove</button>
											</div>
										 
									</div>
										<button type="button" class="add-field btn btn-primary">Add more service</button>
							</div>
