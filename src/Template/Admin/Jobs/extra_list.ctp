	...
	<div id="ribbon">
		...
		<ol class="breadcrumb">
			<li>
			 ...
			 <li>
					<?php echo $this->Html->link('Service List', '/admin/jobs/'); ?>
             </li>
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											...
											?>
												<tr> 
													<td><?php echo h($job->extra_service_name); ?></td>
													<td><?php echo h($job->service_money_value)?></td>
													<td class="actions">
														<?= $this->Form->postLink('<i class="fa fa-trash-o"></i>',['action' => 'delete_extra', $job->id],['escape'=>false,'class'=>'on-default remove-row','title'=>'Delete'],['confirm' => 'Are you sure want to delete?'])?>
													</td>										
												</tr>
											<?php } ?>
											</tbody>
