										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													...
													<th data-hide="phone">House no</th>
													<th data-hide="phone">Zip_Code</th>
													<th data-hide="phone">City</th>
													<th data-hide="phone">Payable Money</th>
													<th data-hide="phone">Apply for job</th>
												</tr>
											</thead>
											<tbody>
												<?php foreach($jobs as $val) {
															?>
																	<tr>
																		...
																		<td> <?php echo $val['house_no']; ?></td>
																		<td> <?php echo $val['zip_code']; ?></td>
																		<td> <?php echo $val['city']; ?></td>
																		<td> <?php echo $val['payable_money']; ?></td>
																		<?php if($val['status'] == 1) { ?>
																	<td>
											<?php echo $this->Form->postLink( "<i class='fa fa-ban'></i>", ['action'=>'applyjob', $val['scheduled_service_id']],['escape' => false, 'title' => 'Apply this job', 'class' => 'jobs'],['confirm' => 'Are you sure want to apply this job ?']);?>
																	</td>		
																<?php } else { ?>
														<td>
															<?php echo $this->Html->image('icon/apply.png', ['alt' => 'already applied']); ?>
														</td>
