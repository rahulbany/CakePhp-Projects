...
<div id="main" role="main">
	<div id="ribbon">
		...
		<ol class="breadcrumb">
				...
				<li><?php echo $this->Html->link('Open jobs', '/admin/jobs/openJob'); ?></li>
				<li>Asign Job	</li>
		</ol>
	</div>
					...
					<div class="row">
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<!-- table start   -->
								<?php echo $this->Form->create(null,['class'=>'smart-form','id'=>'smart-form-register','action'=>'assignJob']);  ?>
							<header>
							Assign Jobs
							</header>
							<fieldset>
									...
									<section>
									<label class="select">
									  <select multiple="multiple" placeholder="Select category" name="partner[]" class="SlectBox" required style="height:170px;">
									<option value="" selected="" >--Select partner--</option>
												<?php if(!empty($allPartner)) {
													foreach($allPartner as $val) { ?>
													<option value="<?php echo $val['partner__id'] ?>"> <?php echo $val['user__first_name']; ?></option>	
													<? }
												} else { ?> <option value=""> No Partner found </option> <?php }  ?>
										</select>
										</label>
								</section>
								<?php echo $this->Form->hidden('service_id',['value'=>$serviceID]);?>
							</fieldset>
							<footer>
