		...
		<section id="widget-grid" class="">
					<div class="row">
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<?php echo $this->Form->create(null, ['url' => ['controller' => 'jobs', 'action' => 'percentage'],'class'=>'smart-form','id'=>'smart-form-register']); ?>
							<header>
							Add Percentage
							</header>
							<fieldset>
								<div class="row">
									<section class="col col-6">
										<label class="input">
											...
											<?php echo $this->Form->input('percentage',['value'=>$data->percentage,'label'=>false]); ?>
										</label>
									</section>
								</div>
