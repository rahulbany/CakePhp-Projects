	...
	<div id="ribbon">
		...
		<ol class="breadcrumb">
			<li>
			 ...
			 <li>
					<?php echo $this->Html->link('Add Service', '/admin/jobs/add'); ?>
             </li>
			 <li>
					Service Management
             </li>
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													...
													<!--th data-hide="phone,tablet">Service size </th-->												
											...
											?>
												<tr> 
													<td><?php echo h($job->service); ?></td>
													<!--td><!--?php //echo h($job->yard->yards)?></td-->
													<td><?php echo h($job->job_type); ?></td>
													<!--td><!--?php  echo "$".h($job->amount); ?></td-->
													<td class="actions">
													
														<?php echo $this->Html->link($this->Html->image('icon/edit.png', ['alt'=>'edit', 'title'=>'Edit','width' => '17']), ['action' => 'edit', $job->id] ,['escape' => false]).'&nbsp;&nbsp;&nbsp;'; ?>
																
													<?php echo $this->Form->postLink($this->Html->image('icon/delete.png', ['alt'=>'delete', 'title'=>'Delete','width' => '17']), ['action' => 'delete', $job->id], ['escape' => false,'confirm' => 'Are you sure?']).'&nbsp;&nbsp;&nbsp;'; ?>
													
														<?php echo $this->Form->postLink($this->Html->image('icon/list.png', ['alt'=>'extra_list', 'title'=>'extra service list','width' => '17']), ['action' => 'extra_list', $job->id], ['escape' => false]).'&nbsp;&nbsp;&nbsp;'; ?>
														
														<?php echo $this->Form->postLink($this->Html->image('icon/add.png', ['alt'=>'add yards', 'title'=>'add service yards','width' => '17']), ['action' => 'add_yards', $job->id], ['escape' => false]).'&nbsp;&nbsp;&nbsp;'; ?>
													</td>										
												</tr>
											<?php } ?>
											</tbody>
