										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											...
											?>
												<tr> 
													...
													<td class="actions">
														 <?php echo  $this->Form->postLink('<i class="fa fa-list-ol"></i>',['action' =>'allpartners',$job['PartnerProvidedServices__id']],['escape'=>false,'class'=>'on-default remove-row','title'=>'Partner List']); ?> 
													</td>	
												</tr>
											<?php } ?>
											</tbody>
