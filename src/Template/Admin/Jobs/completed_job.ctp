										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													...
													<th data-hide="phone,tablet">Service Status</th>									
								
	
												</tr>
											</thead>
											<tbody>
											<?php foreach($compleated as $job) {
											
												?>
												<tr> 
													<td><?php echo h($job['PartnerProvidedServices__service']); ?></td>
													<td><?php echo h($job['PartnerProvidedServices__job_type']); ?></td>
													<td><?php echo h($job['CustomerPropertys__street_address']); ?></td>
													<td><?php echo h($job['CustomerPropertys__city']); ?></td>
													<td><?php echo h($job['CustomerPropertys__zip']); ?></td>
													<!--td><!--?php echo h($job['ScheduledServices__payable_money']); ?></td-->
													<td><?php echo h($job['ScheduledServices__is_done']); ?></td>
													 <!-- echo h(date('Y-M-d',strtotime($job['ScheduledServices__created_at']))); ?></td> -->
