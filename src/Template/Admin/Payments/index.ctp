								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											...
											?>
												<tr>
													<td><?php echo h($value['scheduled_service']['is_done']);  ?></td>
													<td><?php echo date('Y-M-d',strtotime("next Monday")); ?></td>
														<?php $date = date('Y-m-d',strtotime("next Monday")); ?>
													<td><?php echo '$'.h($value['scheduled_service']['payable_money']);  ?></td>
													<td> <?php echo $this->Html->link( 'view',  ['controller' => 'Payments', 'action' => 'view', $date] );?></td>		
												</tr>
											<?php } ?>	
											</tbody>
										</table>
