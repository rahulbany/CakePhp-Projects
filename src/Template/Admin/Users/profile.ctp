							...
							<div data-widget-editbutton="false" data-widget-colorbutton="false" id="wid-id-0" class="jarviswidget jarviswidget-sortable" role="widget">
								...
								<div role="content">
									...
									<div class="widget-body no-padding">
											<?php echo $this->Form->create(@$new, ['class'=>'smart-form']);  ?>	
											<fieldset>					
												...
												<section>
													...
													<label class="input">
													<?php echo $this->Form->input('first_name',['value'=>$userInfo->first_name,'label'=>false]); ?>
													</label>
												...
												<section>
													...
													<label class="input">
													<?php echo $this->Form->input('last_name',['value'=>$userInfo->last_name,'label'=>false]); ?>
													</label>
													<div class="note">This is a required field.</div>
												</section>
												...
												<section>
													...
													<label class="input">
													<?php echo $this->Form->input('email',['value'=>$userInfo->email,'label'=>false]); ?>
													</label>
													<div class="note">This is a required field.</div>
												</section>
...
<!---  CHANGE IMAGE POP UP-->
<div id="light" class="white_content" style="height:300px;">
									<div data-provides="fileupload" class="fileupload fileupload-new">
											 <div style="width: 200px; height: 150px;" class="fileupload-preview thumbnail">
											  ...
											  <?php echo $this->Form->create(@$data,array('url'=>array('controller'=>'Users','action'=>'changeImage'),'type' => 'file')); ?>
