	...
	<!--	<span class="ribbon-button-alignment"> 
		...
		<ol class="breadcrumb">
			<li>
			 ...
			 <li>
				<?php echo $this->Html->link('Add Partners',['controller'=>'Partners','action'=>'add'] ); ?>
             </li>
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													...
													<th data-hide="phone,tablet"><i class="fa fa-fw fa-calendar txt-color-blue hidden-md hidden-sm hidden-xs"></i> Created</th>
											...
											?>
												<tr> 
													<td><?php echo h($partner->first_name); ?></td>
													<td><?php echo h($partner->last_name); ?></td>
													<td><?php echo h($partner->email); ?></td>
													<td><?php echo h(date("Y-M-d",strtotime($partner->created_at))); ?></td>	
													<td><?php echo $this->Html->image("icon/credit1.png",["alt"=>"credit info","title"=>"Add credit card information",'url'=>['controller'=>'Partners','action'=>'creditCardsInfo',$partner->id]]);?></td>	
												</tr>
											<?php } ?>
											</tbody>
										</table>
