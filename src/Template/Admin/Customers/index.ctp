								...
								<div>
									...
									<div class="widget-body no-padding">
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											...
											<tbody>
											<?php foreach($customer as $partner) {
											?>
												<tr> 
													...
													<td><?php echo $this->Html->image("icon/credit1.png",["alt"=>"credit info","title"=>"Add credit card information",'url'=>['controller'=>'Customers','action'=>'creditCardsInfo',$partner->id]]);?></td>												
												</tr>
											<?php } ?>
											</tbody>
										</table>
