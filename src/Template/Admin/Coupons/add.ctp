...
<div id="main" role="main">
	...
	<div id="content">
		...
		<section id="widget-grid" class="">
				...
				<?php echo $this->Form->create($user,['class'=>'smart-form','id'=>'smart-form-register']);  ?>
							<header>
								Add  Coupons
							</header>
							<fieldset>
								<section>
									<label class="input"> 
										<input type="text" name="discount_code" placeholder="Add Discount Coupon" required>
									 </label>
								</section>
									...
									<section>
									<label class="input"> 
										<input type="text" name="discount_money_value" placeholder="Add Coupon Amount" required>
									 </label>
								</section>

								<section>
									<label class="input"> 
									<input type="text" name="created_at"  id="datepicker" placeholder="From Date (MM/DD/YY)" required>
									</label>
								</section>
								
								<section>
									<label class="input"> 
									<input type="text" name="ending_time"  id="datepicker2" placeholder="To Date (MM/DD/YY)" required>
									</label>
								</section>
