...
<div id="main" role="main">
	<div id="ribbon">
		...
		<li>
			 ...
			 <li>
				<?php echo $this->Html->link('Add Pages',['controller'=>'Pages','action'=>'add'] ); ?>
             </li>			 
			 <li>Page List</li>
		</ol>
	</div>
								...
								<div>
									...
									<div class="widget-body no-padding">
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													<th data-hide="phone,tablet">Page Title</th>
													<th data-hide="phone,tablet">Page Slug</th>												
													<th data-hide="phone,tablet">Seo Title</th>												
													<th data-hide="phone,tablet">Created Date</th>
													<th>Action</th>
												</tr>
											</thead>
											<tbody>
											<?php foreach($allPage as $data) {
											?>
												<tr> 
													...
													<td><?php echo $this->Html->link($this->Html->image('icon/edit.png', ['alt'=>'edit', 'title'=>'Edit','width' => '17']), ['action' => 'edit', $data->id] ,['escape' => false]);?></td>												
												</tr>
											<?php } ?>
											</tbody>
										</table>
