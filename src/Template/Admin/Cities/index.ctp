	...
	<div id="ribbon">
		...
		<ol class="breadcrumb">
			<li>
			 ...
			 <li>
				<?php echo $this->Html->link('Add City',['controller'=>'Cities','action'=>'add']); ?>
             </li>
			 <li> City List </li>
		</ol>
	</div>
			...
			<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
						<ul id="sparks" class="">
							<li class="sparks-info">
								...
								<li class="add-data">
								<?php echo $this->Html->image("icon/add_record.gif", ['alt' => 'addrecord', 'title'=>'Add record', 'url' => ['controller' => 'cities', 'action' => 'add']]); ?>
								</li>	
								</div>
							</li>
						</ul>
								...
								<div>
									...
									<div class="widget-body no-padding">
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											...
											<tbody>
											<?php foreach($AllCities as $data) {
											?>
												<tr> 
													<td><?php echo h($data->city); ?></td>
													<td><?php echo h($data->slug); ?></td>
													<td><?php echo h($data->state->name); ?></td>
													<td><?php echo h($data->seo_title); ?></td>
													...
													<?php echo $this->Form->postLink($this->Html->image('icon/delete.png', ['alt'=>'delete', 'title'=>'Delete','width' => '17']), ['action' => 'delete', $data->id], ['escape' => false,'confirm' => 'Are you sure?'] ); ?>
